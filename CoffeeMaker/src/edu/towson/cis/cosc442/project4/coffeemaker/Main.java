...
public class Main {
	...
	public static void addRecipe() {
	    //Read in recipe name
	    String name = inputOutput(System.lineSeparator() + "Please enter the recipe name: ");
	    
	    //Read in recipe price
	    String priceString = inputOutput(System.lineSeparator() + "Please enter the recipe price: $");
	    ...
	    //Read in amt coffee
	    String coffeeString = inputOutput(System.lineSeparator() + "Please enter the units of coffee in the recipe: ");
	    ...
	    //Read in amt milk
	    String milkString = inputOutput(System.lineSeparator() + "Please enter the units of milk in the recipe: ");
	    ...
	    //Read in amt sugar
	    String sugarString = inputOutput(System.lineSeparator() + "Please enter the units of sugar in the recipe: ");
	    ...
	    String chocolateString = inputOutput(System.lineSeparator() + "Please enter the units of chocolate in the recipe: ");
    ...
    public static void addInventory() {
	    //Read in amt coffee
	    String coffeeString = inputOutput(System.lineSeparator() + "Please enter the units of coffee to add: ");
	    int amtCoffee = stringToInt(coffeeString);
	    if(amtCoffee < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt milk
	    String milkString = inputOutput(System.lineSeparator() + "Please enter the units of milk to add: ");
	    int amtMilk = stringToInt(milkString);
	    if(amtMilk < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt sugar
	    String sugarString = inputOutput(System.lineSeparator() + "Please enter the units of sugar to add: ");
	    int amtSugar = stringToInt(sugarString);
	    if(amtSugar < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt chocolate
	    String chocolateString = inputOutput(System.lineSeparator() + "Please enter the units of chocolate to add: ");
	    int amtChocolate = stringToInt(chocolateString);
	    if(amtChocolate < 0) {
	    	mainMenu();
	    }
